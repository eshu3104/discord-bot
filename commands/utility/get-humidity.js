...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('get-humidity')
        .setDescription('Provides information about the humidity today.')
        .addStringOption(option =>
            option.setName('city')
                .setDescription('The city you would like the humidity for')
                .setRequired(true)
        )
        .addStringOption(option =>
    ...
    async execute(interaction) {
        ...
        request({ url: url, json: true }, function (error, response, body) {  
            ...
            if (body.main && body.main.temp !== undefined) {  
                interaction.reply(`The humidity in ${body.name}, ${body.sys.country} is ${body.main.humidity} percent.`);
            } else {
