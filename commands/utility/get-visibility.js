...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('get-visibility')
        .setDescription('Provides information about the visibility conditions today.')
        .addStringOption(option =>
            option.setName('city')
                .setDescription('The city you would like the visibility for')
                .setRequired(true)
        )
        .addStringOption(option =>
    ...
    async execute(interaction) {
        ...
        request({ url: url, json: true }, function (error, response, body) {  
            ...
            if (body.main && body.main.temp !== undefined) {  
                interaction.reply(`The visibility in ${body.name}, ${body.sys.country} is ${body.visibility} meters.`);
            } else {
