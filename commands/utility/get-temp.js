...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('get-temp')
        .setDescription('Provides information about the current temperature.')
    ...
    async execute(interaction) {
        ...
        request({ url: url, json: true }, function (error, response, body) {  
            ...
            if (body.main && body.main.temp !== undefined) {  
                interaction.reply(`It is currently ${body.main.temp} degrees Celsius in ${body.name}, ${body.sys.country}.`);
            } else {
