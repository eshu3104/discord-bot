...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('get-pressure')
        .setDescription('Provides information about the air pressure today.')
        .addStringOption(option =>
            option.setName('city')
                .setDescription('The city you would like the air pressure for')
                .setRequired(true)
        )
        .addStringOption(option =>
    ...
    async execute(interaction) {
        ...
        request({ url: url, json: true }, function (error, response, body) {  
            ...
            if (body.main && body.main.temp !== undefined) {  
                interaction.reply(`The air pressure in ${body.name}, ${body.sys.country} is ${body.main.pressure} milibars.`);
            } else {
