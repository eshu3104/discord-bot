...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('get-min-temp')
        .setDescription('Provides information about the minimum temperature today.')
    ...
    async execute(interaction) {
        ...
        request({ url: url, json: true }, function (error, response, body) {  
            ...
            if (body.main && body.main.temp !== undefined) {  
                interaction.reply(`The minimum temperature today in ${body.name}, ${body.sys.country} is ${body.main.temp_min} degrees Celsius.`);
            } else {
